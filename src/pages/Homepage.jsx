...
const Homepage = () => {
  return (
    <div className=" relative flex lg:ml-28 lg:mr-28 sm:ml-10 sm:mr-10 h-[100vh]">
      <div className="w-[60%] flex flex-col mt-20 space-y-10 h-[100%] max-sm:flex-1 max-sm:p-10 max-sm:mt-10">
        ...
        <div className="flex justify-around max-sm:justify-between items-center" >
      ...
      <div className="hidden sm:flex bg-[#fcf5f3] w-[40%] h-[100%] ">
